...
- `MyHomeLib.exe`: `Success`, 0 ошибок, 0 предупреждений;
- `MHLMcpServer.exe`: `Success`, 0 ошибок, 0 предупреждений;
- `prepare-runtime.ps1` подтвердил разрядность и полный набор SQLite, zstd,
  значков, 7-Zip и JPEG XL;
- прошли 47 протокольных/поисковых сценариев, 10 extract-тестов и полный набор
  cache-тестов;
...
Win32 для этой новой ветки ещё должен быть собран и проверен после ручного
одобрения Win64 владельцем.
