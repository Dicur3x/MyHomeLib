...
// Russian is the source language; Ukrainian, English and Bulgarian are the
// translations we ship. A locale listed here is regenerated by every
// extractor run.
//
// Bulgarian carries its machine-translation disclosure in the name itself.
// That string is what the language menu renders, so every user sees the caveat
// before selecting it, at no code cost -- see
// docs/superpowers/specs/2026-08-11-bulgarian-locale-design.md.
const LOCALES = [
  { code: 'ru', name: 'Русский' },
  { code: 'uk', name: 'Українська' },
  { code: 'en', name: 'English' },
  { code: 'bg', name: 'Български (машинен превод)' },
];
...
function main() {
  ...
  // Locales are processed in the order above, and a naive load-merge-write
  // loop could already have written earlier catalogs by the time it discovered
  // a broken later one -- a partial write is
