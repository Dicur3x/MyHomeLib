...
{
TODO -oNickR -cBug: если поменять путь на устройство и указан относительный путь к читалке, то она перестает запускаться. после перезапуска проги все нормально
}
